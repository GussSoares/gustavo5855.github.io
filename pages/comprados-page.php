				...
				<section>
					...
					<div class="card-deck" style="margin-top: 2%;">
						...
						<div class="row">
							...
							$busca = "SELECT livro.*, id_comprador, qtd_comprada FROM livro JOIN livros_comprados ON
                                    livro.id=livros_comprados.id_livro AND livros_comprados.id_comprador = $id";
                                    ...
                                    <div class="modal-content">
                                        <form method="post" action="../edit-livro.php" enctype="multipart/form-data" id="formcadlivro" name="formcadlivro">
                                            ...
                                            <div class="modal-footer d-flex justify-content-center">
                                                ...
                                                <input type="submit" class="btn btn-unique" value="Finalizar"/>
                                            </div>
                                        </form>
                                    </div>
                                </div>
